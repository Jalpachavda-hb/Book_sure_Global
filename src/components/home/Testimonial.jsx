...
// import "./Hero.css";
// import {fetchActiveTestimonials} from "../../utils/Getdata"
...
const Testimonial = () => {
  ...
  useEffect(() => {
    const getTestimonials = async () => {
      ...
      const activeData = data.filter((item) => item.Is_Active === 1);
            ...
            <Slider {...sliderSettings} className="testimonial-slider">
              ...
              {testimonials.length > 0 ? (
                testimonials.map((item) => (
                  <div key={item.TestimonialMasterId}>
                    <div className="testimonial-content-wrap">
                      ...
                      <div className="author-info">
                        <h4>
                          ...
                          <span>{item.TestimonialClientRole}</span>
                        </h4>

                        <p>
                          {item.TestimonialCompanyName} -{" "}
                          {item.TestimonialCompanyType}
                        </p>
