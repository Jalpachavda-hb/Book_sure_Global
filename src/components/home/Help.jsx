...
import "./Hero.css";
import bgImage from "../../assets/Images/bgabout.jpg";
import { getHelp } from "../../utils/Getdata";
  ...
  return (
    ...
    >
      <div className="container">
        ...
        <div className="row align-items-center">
          {/* <div className="hero-content-left animated-content position-relative z-index text-white">
            <h4 className="page-tital mt-1">{helpData?.maintitle}</h4>
          </div> */}
          <div className=" hero-content-left animated-content position-relative z-index text-white mb-4">
            <h3 className="page-tital mt-1">{helpData?.maintitle}</h3>
            <p className="contain-colur">"{helpData?.title}"</p>
          </div>
        </div>
        ...
        <div className="row">
          <div className="col-lg-6 col-md-12 col-12">
            <div className="animated-down paraabout">
              {/* <h3 className="mb-3">{helpData?.title}</h3> */}
